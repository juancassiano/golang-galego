...
// CriarPublicacao cria uma publicacao no banco de dados
...
// BuscarPublicacoes lista todas as publicacoes do feed do usuário
...
// BuscarPublicacao traz os detalhes de uma publicacao
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não e possível atualizar uma publicação que não é sua"))
		return
	}
	corpoRequisicao, err := ioutil.ReadAll(r.Body)
	if err != nil {
...
// DeletearPublicacao deleta uma publicacao
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não e possível deletar uma publicação que não é sua"))
		return
	}
...
// BuscarPublicacoesPorUsuario traz todas as publicacoes de um usuario
